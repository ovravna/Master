...
% Menno P. Witter, the main stakeholder and neurologist consulting this research, 
...
% Waxholm space rat brain as AR application with AR interaction
% Fusion of surface rendering and volumetric data
% collaborative experience between AR HMD and Android
% Design a medical AR application of high usability

% Throughout this thesis the contributions of the research project have been explored. 
% The research in 
As explored in the prior sections this research project has produced an IT artifact with promising results as a teaching tool. This section will expand upon the contributions to the field.
