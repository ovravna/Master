...
\begin{figure}[ht]
    \includegraphics[width={\textwidth},trim={2.5cm 4cm 4.5cm 2cm},clip]{fig/brainmodeldecimateratio2.png}
...
\subsubsection*{Coloring the brain}

Throughout this thesis the reader will see the brain visualized in a number of different colors.
