...
The first meeting initializing the project took place at VRLab Dragvoll in early September, here the researcher was introduced to the general background and the problem description of how the neurologist stakeholders envisioned the use of AR for neuroanatomical education. It was explained how cadavers for education are difficult to acquire and therefore used quite sparingly. 
